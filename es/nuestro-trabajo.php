        ...
        <div class="pt-page pt-page-1">
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco">
                    ...
                    <ul class="texto">
                        <li>En 2016 se extendió a dos nuevas instituciones educativas, llegando en total a 19, lo cual representa el 50% de los colegios oficiales urbanos del municipio. </li>
                        <li>Se realizó Expo EAU, evento en el cual las instituciones educativas presentaron las principales fortalezas y logros obtenidos con la implementación del modelo.</li>
                        <li>Se consolidó el equipo de apoyo para dinamizar los procesos de EAU con directivos y docentes. </li>
