...
<div class="container principal">
    ...
    <div class="row  pt-wrapper">
        ...
        <div class="col-sm-3 col-izq">
            <img src="img/gruposinteres2.png" class="img_izquierda hidden-xs" alt="">
        </div>
            ...
            <div class="row contenido">
                ...
                <h5 class="destacado azul">Contratistas 2016</h5><br>                
                    <ul class="lista_grupos">
                        ...
                        <li>Agencia Mass Medios S.A.S</li>
                        <li>Alberto Álvarez López – GTI</li>
                        <li>Alexander Serna López</li>
                        <li>Andrea Armel Sanint</li>
                        <li>Ángela María Márquez Briceño</li>
                        <li>Asociación Nacional de Fondos de Empleados, ANALFE</li>
                        <li>Aviatur S.A.</li>
            ...
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco texto"><br><br>         
                    <ul class="lista_grupos">
                        ...
                        <li>Sociedad Once Caldas S.A.</li>
                        <li>Sonia Yanet Castañeda Gallo</li>
                        <li>Think Marketing Estratégico</li>
                        <li>Una Tinta Medios S.A.S.</li>
                        <li>Unión Constructora Álamos S.A.S.</li>
                        <li>Urabosques S.A.S.</li>
