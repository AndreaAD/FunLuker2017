...
<div class="container principal">
    ...
    <div class="row  pt-wrapper">
        <div class="col-sm-5 col-izq">
            <img src="img/valores1.png" class="img_izquierda hidden-xs" alt="">
        </div>
        <div class="col-sm-8">
        </div>
        <div class="col-sm-3 col-izq">
            <img src="img/valores2.png" class="img_derecha hidden-xs" alt="">
        </div>
            ...
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco texto">
                    ...
                    <ul class="sinMargin">
                        ...
                        <li>De la institucionalidad, la normatividad y la ley</li>
                    </ul>
                </div>
                <div class="col-sm-3 col-izq">
