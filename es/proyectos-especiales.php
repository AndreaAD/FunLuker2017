    ...
    <div class="row  pt-wrapper">
        <div class="pt-page pt-page-1">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_1.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-2">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_2.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-3">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_3.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco">
                    ...
                    <ul class="texto">
                        ...
                        <li>11 madres conforman la red de lactancia materna comunitaria.</li>
                        <li>95% de afiliación al sistema de salud </li>
                        <li>95% de madres con planificación familiar </li>
                        <li>100% de niños con el esquema de vacunación completo </li>
                        <li>65% de las madres adoptaron estilos de vida saludables </li>
                        <li>44% de las madres se vincularon a la vida laboral </li>
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_4.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-5">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_5.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco">
                    ...
                    <ul class="texto">
                        ...
                        <li>Se fortalecieron los lazos de Batuta con las familias de los beneficiarios y los padres participaron más activamente en el proceso de formación de sus hijos.</li>
                        <li>Se hizo una alianza con el Club Activo 20-30 en la comuna La Fuente, que permite tener un semillero musical de niños de primera infancia.</li>
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_6.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-7">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_7.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco">
                    ...
                    <ul class="texto">
                        ...
                        <li>2.400 personas reciben información periódica del programa </li>
                        <li>1.000 beneficiarios directos del Premio Cívico asociado al programa</li>
                        <li>Se lograron 235 publicaciones en medios de comunicación nacionales valoradas en $2.107 millones.</li>
                        <li>El programa entregó insumos y recomendaciones al plan de desarrollo municipal 2014-2017: 17 menciones de MCV en el plan de desarrollo.</li>
                        <li>Se definieron compromisos en busca de una agenda concertada de desarrollo local de cara a los Objetivos de Desarrollo Sostenible, ODS</li>
                        <li>Se actualizó el Índice de Progreso Social, IPS, para diez ciudades de Colombia de la Red de Ciudades Cómo Vamos, dentro de la cual se encuentra Manizales.</li>
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_8.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-9">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_9.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-10">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_10.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-11">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_11.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-12">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_12.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-13">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_13.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
        <div class="pt-page pt-page-14">
            <div class="row contenido">
                ...
                <div class="col-sm-3 padd-lef col-izq">
                    <img src="img/proyecto_des_14.png" class="img_derecha hidden-xs" alt="">
                </div>
            </div>
        </div>
	</div>
