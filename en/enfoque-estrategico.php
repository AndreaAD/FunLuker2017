...
<div class="container principal">
    ...
    <div class="row  pt-wrapper">
        <div class="col-sm-5 col-izq">
            <img src="img/enfoque1.png" class="img_izquierda hidden-xs" alt="">
        </div>
        <div class="col-sm-8">
        </div>
        <div class="col-sm-3 col-izq">
            <img src="img/enfoque2.png" class="img_derecha hidden-xs" alt="">
        </div>
        <div class="pt-page pt-page-1">
            <div class="row contenido">
                ...
                <div class="col-sm-8 fondo-blanco">
                    ...
                    <h5 class="destacado azul">Misión</h5>
                    ...
                    <h5 class="destacado azul">Visión</h5>
